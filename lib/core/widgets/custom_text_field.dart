    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        errorBorder: widget.errorBorder ??
            OutlineInputBorder(
              borderSide: BorderSide(
                color: ColorManager.red, // لون الحدود عند وجود خطأ
                width: 1.3,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),
        focusedErrorBorder: widget.focusedErrorBorder ??
            OutlineInputBorder(
              borderSide: BorderSide(
                color:
                    ColorManager.red, // لون الحدود عند وجود خطأ أثناء التركيز
                width: 1.3,
              ),
              borderRadius: BorderRadius.circular(16.0),
            ),
        ...
        hintStyle: widget.hintStyle ?? FontsManager.font13GreyRegular,
        hintText: widget.hintText,
      ),
      obscureText: widget.isObsecure,
      style: widget.inputTextStyle ?? FontsManager.font13DarkBlueRegular,
    );
  }
}
